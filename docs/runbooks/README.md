...
| `14` | `14-governed-intent-capability-recall.md` | `v0.1.1` | Planned | `2026-08-03` | LLM-first IntentEnvelope and governed closed-set capability recall; no Knowledge/RAG in MVP; next implementation entry |
